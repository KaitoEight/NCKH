...
from tensorflow.python.keras.layers import Input, Dense, Dropout, Activation, TimeDistributed
from tensorflow.python.keras.layers import Conv2D, MaxPooling2D, BatchNormalization, Flatten
